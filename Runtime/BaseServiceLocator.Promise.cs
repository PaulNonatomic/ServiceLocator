...
namespace Nonatomic.ServiceLocator
{
    public abstract partial class BaseServiceLocator
    {
        ...
        public virtual void RejectService<T>(Exception exception) where T : class
        {
            ...
            {
                var serviceType = typeof(T);
                RejectPromises(serviceType, exception);
            }
        }
        ...
        /// </summary>
        protected override void ResolvePromises(Type serviceType, object service)
        {
        ...
        /// </summary>
        protected override void RejectPromises(Type serviceType, Exception? exception = null)
        {
            if (!PromiseMap.TryGetValue(serviceType, out var taskList))
            {
                return;
        ...
        /// </summary>
        protected override void CleanupPromises()
        {
