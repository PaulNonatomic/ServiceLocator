...
namespace Tests.PlayMode
{
	...
	public class ServiceLocatorPromiseTests
	{
		...
		public IEnumerator Promise_CancelledWhenGameObjectDestroyed()
		{
			...
			_serviceLocator.GetService<ServiceLocatorTestUtils.TestService>()
		...
		public IEnumerator Promise_WithExplicitCancellation_IsCancelled()
		{
			...
			var promise = _serviceLocator.GetService<ServiceLocatorTestUtils.TestService>(cts.Token)
		...
		public IEnumerator ServicePromise_MultiService_AllResolveWhenRegistered()
		{
			...
			_serviceLocator
				.GetService<ServiceLocatorTestUtils.TestService, ServiceLocatorTestUtils.AnotherTestService>()
				.Then(services =>
				{
