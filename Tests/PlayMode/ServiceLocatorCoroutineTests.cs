...
namespace Tests.PlayMode
{
    ...
    public class ServiceLocatorCoroutineTests
    {
        ...
        public IEnumerator ServiceCoroutine_NotAffectedByGameObjectDestruction()
        {
            ...
            bool serviceRetrieved = false;
            TestService retrievedService = null;
            
            // Start a coroutine manually
            var coroutine = _serviceLocator.GetServiceCoroutine<TestService>(service => {
        ...
        public IEnumerator ServiceCoroutine_RetrieveMultipleServices_SequentialRequests()
        {
            ...
            var service1 = new TestService { Message = "First Service" };
            _serviceLocator.Register(service1);
            
            // Retrieve first service
            TestService retrievedService1 = null;
            var coroutine1 = _serviceLocator.GetServiceCoroutine<TestService>(service => {
                retrievedService1 = service;
            });
            
            // Process first coroutine to completion
            while (coroutine1.MoveNext()) yield return null;
            ...
            var service2 = new TestService { Message = "Second Service" };
            _serviceLocator.Register(service2);
            
            // Retrieve second service
            TestService retrievedService2 = null;
            var coroutine2 = _serviceLocator.GetServiceCoroutine<TestService>(service => {
                retrievedService2 = service;
            });
            
            // Process second coroutine to completion
            while (coroutine2.MoveNext()) yield return null;
